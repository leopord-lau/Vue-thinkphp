    ...
    <el-row class="storagebuy">
        <el-col :span="24">
            <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb">
                ...
                <el-breadcrumb-item>工程属性设置</el-breadcrumb-item>
            </el-breadcrumb>
        </el-col>
        ...
        <el-col :span="24" class="btn-form">
            <el-col :span="4" class="print">
                <el-button type="primary"  @click="newdocument" plain>新建工程类别</el-button>
            </el-col>
            <el-col :span="24">
...
<script>
import myTable from '../../components/basic-info/attribute-table'
import myDialog from '../../components/basic-info/attribute-dialog'
export default {
    components:{
        myTable,myDialog
    },
    ...
    methods:{
        search(){
            this.$http.post('api/selectProjectType',{keywords:this.keywords}).then((res)=>{
                if(res.data.code===1){
    ...
    created(){
        this.$http.get('api/getProjectType').then((res)=>{
            if(res.data.code===1){
                this.getData=res.data.data;
                this.total1=this.getData.length
            }else{
