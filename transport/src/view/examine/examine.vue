    ...
    <el-row class="storagebuy">
        ...
        <el-col :span="24" class="btn-form">
            <el-col :span="4" class="print">
                <el-button type="primary"  @click="newdocument" plain>新建审核流</el-button>
            </el-col>
            <el-col :span="24">
...
<script>
import myTable from '../../components/basic-info/examine-table'
import myDialog from '../../components/basic-info/examine-dialog'
export default {
    components:{
        myTable,myDialog
    },
    ...
    methods:{
        search(){
            this.$http.post('api/selectCheck',{keywords:this.keywords}).then((res)=>{
                if(res.data.code===1){
