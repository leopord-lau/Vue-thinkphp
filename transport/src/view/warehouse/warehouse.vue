...
<script>
import myTable from '../../components/basic-info/warehouse-table'
import myDialog from '../../components/basic-info/warehouse-dialog'
export default {
    components:{
        myTable,myDialog
    },
    ...
    methods:{
        ...
        search(){
            this.$http.post('api/selectInventory',{keywords:this.keywords}).then((res)=>{
                if(res.data.code===1){
