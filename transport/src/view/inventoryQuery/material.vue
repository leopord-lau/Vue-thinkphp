    ...
    <el-row class="storagebuy">
        <el-col :span="24">
            <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb">
                ...
                <el-breadcrumb-item>物料库存</el-breadcrumb-item>
            </el-breadcrumb>
        </el-col>
        <el-col class="search-box" :span="24">
            <div class="search-container">
            <div class="demo-search material">物料类型：
                <el-select v-model="value" placeholder="类型">
                    <el-option value="type 1">type 1</el-option>
                    <el-option value="type 2">type 2</el-option>
                </el-select> 
            </div>
        ...
        <el-col :span="24" class="btn-form">
            ...
            <el-col :span="24">
                <my-table :tableData="showwhich" id="table"></my-table>
            </el-col>
        </el-col>
    </el-row>
</template>
...
<script>
import myTable from '../../components/reportForm/material-table'
export default {
    components:{
        myTable
    },
    ...
    methods:{
        alldocument(){
            this.showwhich=[{
                materialType:'type 1',materialNumber:'IMW-1234-456',materialName:'material 1',spec:'big',
                number:'4561',unit:'kg',inventory:'仓库 1',loader:'广州',total:'456123'
            },{
                materialType:'type 2',materialNumber:'AQF-4569-452',materialName:'material 2',spec:'medium',
                number:'6851',unit:'kg',inventory:'仓库 2',loader:'广州',total:'78913'
            }]
        },
        print(){
