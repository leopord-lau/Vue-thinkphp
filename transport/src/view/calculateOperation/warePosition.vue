    ...
    <el-row class="storagebuy">
        <el-col :span="24">
            <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb">
                ...
                <el-breadcrumb-item>货位盘点</el-breadcrumb-item>
            </el-breadcrumb>
        </el-col>
...
<script>
import myTable from '../../components/storageOperation/warePosition-table'
export default {
    components:{
        myTable
    },
    ...
    methods:{
        ...
        search(){
            this.$http.post('api/selectWareposition',{keywords:this.keywords}).then((res)=>{
                if(res.data.code===1){
    ...
    created(){
        this.$http.get('api/getWareposition').then((res)=>{
            if(res.data.code===1){
                this.getData=res.data.data;
                this.total1=this.getData.length
            }else{
