    ...
    <el-row class="storagebuy">
        <el-col :span="24">
            <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb">
                ...
                <el-breadcrumb-item>货币汇率</el-breadcrumb-item>
            </el-breadcrumb>
        </el-col>
        ...
        <el-col :span="24" class="btn-form">
            <el-col :span="4" class="print">
                <el-button type="primary"  @click="newdocument" plain>新建货币汇率</el-button>
            </el-col>
            <el-col :span="24">
                <my-table :tableData="showwhich"></my-table>
            </el-col>
        </el-col>
        <el-col :span="24" class="mydialog">
            <my-dialog v-show="dialogTableVisible" @close="closedialog"></my-dialog>
        </el-col> 
    </el-row>
</template>

<script>
import myTable from '../../components/basic-info/exchangeRate-table'
...
export default {
    ...
    methods:{
        alldocument(){
            this.showwhich=[{
                country:'中国',exchangerate:'1'
            },{
                country:'美国',exchangerate:'6.5'
            }]
        },
        search(){
        },
