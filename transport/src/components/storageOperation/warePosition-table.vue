...
<div>
    <el-table :data="tableData.slice((currentPage-1)*pageSize,currentPage*pageSize)" stripe style="width:100%" class="select-form">
        <el-table-column prop="wareSection" label="货区"></el-table-column>
        <el-table-column prop="wareShelf" label="货架"></el-table-column>
        <el-table-column prop="warePosition" label="货位"></el-table-column>
        <el-table-column prop="pallet" label="托盘"></el-table-column>
        <el-table-column prop="materialName" label="物料名称"></el-table-column>
        <el-table-column prop="batch" label="批次"></el-table-column>
        <el-table-column prop="accountNumber" label="账面数量"></el-table-column>
        <el-table-column prop="calculateNumber" label="盘点数量"></el-table-column>
