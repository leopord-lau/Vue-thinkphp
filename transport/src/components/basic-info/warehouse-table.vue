...
<div>
    <el-table :data="tableData.slice((currentPage-1)*pageSize,currentPage*pageSize)" stripe style="width:100%" class="select-form">
        ...
        <el-table-column prop="inventoryCode" label="仓库编码"></el-table-column>
        <el-table-column prop="inventoryName" label="仓库名称" width="80px;"></el-table-column>
        <el-table-column prop="address" label="地址"></el-table-column>
        <el-table-column prop="lock" label="电子锁" width="80px;"></el-table-column>
        <el-table-column prop="contactPerson" label="联系人" width="80px;"></el-table-column>
        <el-table-column prop="contactWay" label="联系方式" width="100px;"></el-table-column>
        <el-table-column prop="guardMan" label="仓管员" width="80px;"></el-table-column>
        <el-table-column prop="company" label="公司" width="110px;"></el-table-column>
