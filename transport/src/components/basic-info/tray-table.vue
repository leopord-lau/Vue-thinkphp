...
<div>
    <el-table :data="tableData.slice((currentPage-1)*pageSize,currentPage*pageSize)" stripe style="width:100%" class="select-form">
        ...
        <el-table-column prop="palletName" label="托盘名称" ></el-table-column>
        <el-table-column prop="palletType" label="托盘类型" width=""></el-table-column>
        <el-table-column prop="palletCode" label="托盘编码" width=""></el-table-column>
        <el-table-column prop="warePosition" label="所在货位" width=""></el-table-column>
        <el-table-column prop="remark" label="备注"></el-table-column>
        <el-table-column label="操作">
            <template slot-scope="scope">
                <el-button size="mini" type="primary" @click="handleChange(scope.$index, scope.row)">修改</el-button>
                <el-button size="mini" type="primary" @click="handleDelete(scope.$index, scope.row)">条码打印</el-button>
            </template>
        </el-table-column>
    </el-table>
